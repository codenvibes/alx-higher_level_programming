...
> **Your code becomes storage-agnostic, making it easier to switch storage without rewriting the entire project. <br> "Storage agnostic" refers to the concept that a particular piece of software or code is not tied to a specific type or technology of storage. In the context of databases and Object Relational Mapping (ORM) frameworks, it means that the application or code is designed in a way that it can work with different types of storage systems without requiring significant modifications. <br> For example, if an application is storage agnostic, it should be able to switch from one database management system (DBMS) to another (e.g., from MySQL to PostgreSQL) with minimal or no changes to the application code. <br> In the provided context of SQLAlchemy and ORM, being storage agnostic means that developers can interact with the database using Python objects and queries without being overly concerned about the specific details of how the data is stored, what SQL dialect is used, or other low-level database considerations. The ORM framework takes care of translating these high-level operations into the appropriate SQL statements for the specific database being used, allowing for a more abstract and portable codebase.**
...
# Resources
<details>
<summary><b><a href="https://www.fullstackpython.com/object-relational-mappers-orms.html">Object-relational mappers</a></b></summary><br>
...
<details>
<summary><b><a href="https://mysqlclient.readthedocs.io/">mysqlclient/MySQLdb documentation</a> (please don't pay attention to <code>_mysql</code>)</b></summary><br>
...
File: [model_state.py](https://github.com/codenvibes/alx-higher_level_programming/blob/master/0x0F-python-object_relational_mapping/model_state.py)
</summary>
